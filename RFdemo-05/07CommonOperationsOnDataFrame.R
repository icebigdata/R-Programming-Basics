...
typeof(students$student.names)
students[1:3] # column slicing
students[c("student.physics.marks","student.chemistry.marks")]
students
students[1,2] #Row number, Column number
students[1:3,1:2]
students[c(1,2),c(1,3)] # select individual rows and columns, respectively
students[,1] #select column 1 -> return 1st column dataframe
students[1,] #select row 1 -> return 1st row dataframe
students[c(T,F,T,F),]
